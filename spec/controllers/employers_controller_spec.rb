  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved employer as @employer" do
        ...
        post :create, {:employer => {}}, valid_session
        assigns(:employer).should be_a_new(Employer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested employer" do
        ...
        Employer.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => employer.to_param, :employer => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the employer as @employer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Employer.any_instance.stub(:save).and_return(false)
        put :update, {:id => employer.to_param, :employer => {}}, valid_session
        assigns(:employer).should eq(employer)
      end
